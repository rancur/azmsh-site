...
<div class="azmsh-locked">
  <div class="azmsh-settings">
    ...
    <div class="azmsh-row"><span class="azmsh-label">Region:</span> <span class="azmsh-value" aria-hidden="true">US</span> <span class="azmsh-sr">value shared in Discord</span></div>
    <div class="azmsh-row"><span class="azmsh-label">Modem Preset / Preset:</span> <span class="azmsh-value" aria-hidden="true">ExamplePreset_AZ</span> <span class="azmsh-sr">value shared in Discord</span></div>
    <div class="azmsh-row"><span class="azmsh-label">Frequency Slot:</span> <span class="azmsh-value" aria-hidden="true">00</span> <span class="azmsh-sr">value shared in Discord</span></div>
  </div>
  <div class="azmsh-overlay">
    <span class="azmsh-overlay-text"><span aria-hidden="true">🔒</span> Arizona radio settings are shared in Discord</span>
...
2. **MQTT module:** enter the broker settings provided in Discord. The fields are **Server**, **Username**, **Password**, and **Root topic** on both apps.
    ...
    <div class="azmsh-locked">
      <div class="azmsh-settings">
        <div class="azmsh-row"><span class="azmsh-label">Server:</span> <span class="azmsh-value" aria-hidden="true">broker.example.net:1883</span> <span class="azmsh-sr">value shared in Discord</span></div>
        <div class="azmsh-row"><span class="azmsh-label">Username:</span> <span class="azmsh-value" aria-hidden="true">example_uplink_user</span> <span class="azmsh-sr">value shared in Discord</span></div>
        <div class="azmsh-row"><span class="azmsh-label">Password:</span> <span class="azmsh-value" aria-hidden="true">example_password</span> <span class="azmsh-sr">value shared in Discord</span></div>
        <div class="azmsh-row"><span class="azmsh-label">Root topic:</span> <span class="azmsh-value azmsh-value--clear">msh/US/AZ/{city}</span></div>
      </div>
      <div class="azmsh-overlay">
        <span class="azmsh-overlay-text"><span aria-hidden="true">🔒</span> Broker settings are shared in Discord</span>
        <a class="md-button md-button--primary" href="https://discord.gg/HrKtyuFEQk">Join The Discord</a>
      </div>
    </div>
