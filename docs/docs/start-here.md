...
<div class="azmsh-locked">
  <div class="azmsh-settings">
    ...
    <div class="azmsh-row"><span class="azmsh-label">1. Region:</span> <span class="azmsh-value" aria-hidden="true">US</span> <span class="azmsh-sr">value shared in Discord</span></div>
    <div class="azmsh-row"><span class="azmsh-label">2. Preset:</span> <span class="azmsh-value" aria-hidden="true">ExamplePreset_AZ</span> <span class="azmsh-sr">value shared in Discord</span></div>
    <div class="azmsh-row"><span class="azmsh-label">3. Frequency Slot:</span> <span class="azmsh-value" aria-hidden="true">00</span> <span class="azmsh-sr">value shared in Discord</span></div>
  </div>
...
<div class="azmsh-locked">
  <div class="azmsh-settings">
    ...
    <div class="azmsh-row"><span class="azmsh-label">Name:</span> <span class="azmsh-value" aria-hidden="true">ExampleName</span> <span class="azmsh-sr">value shared in Discord</span></div>
    <div class="azmsh-row"><span class="azmsh-label">Key (PSK):</span> <span class="azmsh-value" aria-hidden="true">ExampleKey==</span> <span class="azmsh-sr">value shared in Discord</span></div>
  </div>
  <div class="azmsh-overlay">
    <span class="azmsh-overlay-text"><span aria-hidden="true">🔒</span> Primary channel name + key are shared in Discord</span>
    <a class="md-button md-button--primary" href="https://discord.gg/HrKtyuFEQk">Join The Discord</a>
  </div>
</div>
